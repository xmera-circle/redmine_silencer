...
Works fine with Redmine 2.0 - 2.6 and Redmine 3.0, whereas the {original repo}[https://github.com/a1exsh/redmine_silencer] doesn't (after commit f6cc13725c)
...
* For Redmine versions 2.4.x - 3.0 use the +master+ branch.
