...
Works fine with Redmine 2.0 - 2.3, whereas the original repo doesn't (after commit f6cc13725c)

* For Redmine versions prior to 2.x, check out the +pre-2.x+ branch.
* For Redmine versions starting from 2.4, check out the +master+ branch.
